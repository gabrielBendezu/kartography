defmodule KartographyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KartographyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KartographyWeb.Gettext, "errors", msg, opts)
    end
  end
